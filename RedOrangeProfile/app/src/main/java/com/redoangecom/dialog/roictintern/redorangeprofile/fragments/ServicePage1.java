...
public class ServicePage1 extends Fragment{
    ...
    private void setData(){
        ...
        String iconCode = getString(R.string.spinner_icon);
        String name = getString(R.string.service1);
        String desc = getString(R.string.special_consultancy);
