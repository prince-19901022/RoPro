...
public class ServicePage3 extends Fragment {
    ...
    private void setData(){
        ...
        String iconCode = getString(R.string.film_icon);
        String name = getString(R.string.service3);
        String desc = getString(R.string.film);
