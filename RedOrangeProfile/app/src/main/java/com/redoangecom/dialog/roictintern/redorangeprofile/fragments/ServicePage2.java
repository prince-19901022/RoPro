...
public class ServicePage2 extends Fragment {
    ...
    private void setData(){
        ...
        String iconCode = getString(R.string.flame_icon);
        String name = getString(R.string.service2);
        String desc =  getString(R.string.graphics);
